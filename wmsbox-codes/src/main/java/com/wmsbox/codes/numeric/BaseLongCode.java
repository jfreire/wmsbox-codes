...
public abstract class BaseLongCode<C extends BaseLongCode<C>> implements LongCode<C> {
	...
	public boolean equals(Object obj) {
		return obj instanceof BaseLongCode && ((BaseLongCode<C>) obj).value == this.value;
	}
